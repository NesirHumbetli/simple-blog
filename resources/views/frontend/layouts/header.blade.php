...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{route('homePage')}}">
        @if($config->logo != null)
        <img width="100" src="{{asset($config->logo)}}">
        @else
        {{$config->title}}
        @endif
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="{{route('homePage')}}">Ana Səhifə</a>
          </li>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('@yield('bg',asset('frontend/img/home-bg.jpg'))')">
